...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Brand </i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => 'brand.store','id'=>'forms','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-15 mb-6">
                        ...
                        {{ Form::textarea('deskripsi',null,['placeholder' => 'Deksripsi','class' => 'form-control '.($errors->has('deskripsi') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    {{-- <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::file('content[]', null, ['placeholder' => 'content', 'class' => 'form-control upload '.($errors->has('content') ? 'is-invalid':''), 'required', 'autocomplete' => 'off', 'id' => 'content1'])}}
                        <img id="preview-image-before-upload1" src="https://www.riobeauty.co.uk/images/product_image_not_found.gif" alt="preview image" style="max-height: 250px;">
