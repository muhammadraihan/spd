...
@section('title', 'Sub Brand Management')
...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i> Module: <span class='fw-300'>Sub Brand </span>
        <small>
            Module for manage Sub Brand.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>
                    Sub Brand  <span class="fw-300"><i>List</i></span>
                </h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('sub_brand.create')}}"><i class="fal fa-plus-circle">
                        </i>
