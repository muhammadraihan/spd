...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Sub Brand</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['sub_brand.update',$sub_brand->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('judul','Judul',['class' => 'required form-label'])}}
                        {{ Form::text('judul',$sub_brand->judul,['placeholder' => 'Judul','class' => 'form-control '.($errors->has('judul') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('judul'))
                    ...
                    <div class="form-group col-md-15 mb-6">
                        ...
                        {{ Form::textarea('detail',$sub_brand->detail,['placeholder' => 'Detail','class' => 'form-control '.($errors->has('detail') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $sub_brand->photo }}"> 
                        @if ($sub_brand->photo)
                            <img src="{{ asset('photo/' . $sub_brand->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
