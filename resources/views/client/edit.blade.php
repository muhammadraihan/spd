...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Client</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('client.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['client.update',$client->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('photo','Photo',['class' => 'required form-label'])}}
                        <input type="hidden" name="oldImage" value="{{ $client->photo }}"> 
                        @if ($client->photo)
                            <img src="{{ asset('photo/' . $client->photo) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                        @else
