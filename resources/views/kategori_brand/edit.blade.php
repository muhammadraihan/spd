...
@section('title', 'Kategori Brand Edit')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>Kategori Brand</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    @endif
                    {!! Form::open(['route' => ['kategori_brand.update',$kategori_brand->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('nama','Nama',['class' => 'required form-label'])}}
                        {{ Form::text('nama',$kategori_brand->nama,['placeholder' => 'Nama','class' => 'form-control '.($errors->has('nama') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                        @if ($errors->has('nama'))
